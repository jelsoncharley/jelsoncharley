import { skills, skillsAll } from "../../data/skillData";
import { Skills } from "./skills";

export function Intro() {
    return <>
        <div className="w-4xl justify-self-center font-mono mb-10">
            ...
            <div>Strategic, motivated, individual with experience developing web-based applications and data management systems,
                ...
                A dynamic team player who collaborates with others to deliver results within tight timeframes. Dedicated to continuous learning and growth that ensures relevance and competencies in a dynamic industry.</div>
        </div>
